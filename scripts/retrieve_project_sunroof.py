...
if __name__ == "__main__":
    ...
    census_tract['region_name'] = (census_tract['STATEFP'] + census_tract['COUNTYFP'] + census_tract['TRACTCE']).astype("int64")
    census_tract = census_tract.dissolve('region_name').reset_index()[['region_name','geometry']]
